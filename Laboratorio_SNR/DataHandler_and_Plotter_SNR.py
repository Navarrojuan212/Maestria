...
class SNRPlotter:
    ...
    def plot_scatter(self, xlabel='Tiempo (Seg)', ylabel='SNR (dB)', title='Dispersión de SNR vs Tiempo', save_path='ruta'):
        plt.figure(figsize=(12, 6))
...
for env_var in env_vars:
    ...
    try:
        ...
        plotter.plot_time_series(
            ...
            save_path=f'Images/TimeSeries/{base_filename}_SNR_TimeSeriesPlot.png'
        )
        ...
        plotter.plot_scatter(
            ...
            save_path=f'Images/Scatter/{base_filename}_SNR_ScatterPlot.png'
        )
        ...
        plotter.plot_histogram(
            ...
            save_path=f'Images/Histogram/{base_filename}_SNR_HistogramPlot.png'
        )
        ...
        plotter.plot_violin_and_box(
            ...
            save_path=f'Images/Violin/{base_filename}_SNR_ViolinPlot.png'
        )
