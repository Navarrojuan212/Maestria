...
file_path = os.getenv('CSV_PATH_LAB_2')
...
plt.ylabel('SNR (dB)')
plt.title('SNR vs. Tiempo (Seg) --- Indoor LAB_2')
plt.legend()
plt.tight_layout()
plt.savefig('Images/SNR_vs_Time_Indoor_LAB_2.png')
#plt.show()
...
plt.xlabel('Tiempo (Seg)')
plt.ylabel('SNR (dB)')
plt.title('Dispersión de SNR vs Tiempo - Indoor LAB_2')
plt.legend()
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('Images/Dispersion_SNR_vs_Tiempo_Indoor_LAB_2.png')
#plt.show()
...
plt.title('Histogram SNR - Indoor LAB_2')
plt.tight_layout()
plt.savefig('Images/Histograma_SNR_Indoor_LAB_2.png')
#plt.show()
...
plt.title('Boxplot SNR - Indoor LAB_2 ')
plt.xticks([1], ['SNR'])
plt.ylabel('SNR (dB)')

# Guardar y mostrar el boxplot
plt.tight_layout()
plt.savefig('Images/Boxplot_SNR_Indoor_LAB_2.png')
#plt.show()
...
plt.title('Distribución de SNR - Indoor LAB_2')
plt.ylabel('SNR (dB)')

# Guardar y mostrar el boxplot
plt.tight_layout()
plt.savefig('Images/Violin_SNR_Indoor_LAB_2.png')
#plt.show()